...
vector<int> erasYears = {10, 21, 5, 5, 4, 4, 4, 13, 9, 4, 5, 17, 8, 6, 21, 6, 4, 5, 4, 14, 9, 10, 9, 13, 4, 15, 13, 15, 5, 7, 7, 2, 4, 2, 4, 45, 15, 64, 31, reiwa};
...
void insertNames()
{
  ...
  {
    names.push_back(make_tuple(erasNames[i], erasYears[i]));
  }
}